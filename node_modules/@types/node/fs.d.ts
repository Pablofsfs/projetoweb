...
declare module "fs" {
     ...
     *
     * ```js
     * import { copyFileSync, constants } from 'nodorm corrective actions after reviewing the error messages, and rerun the tool to completely deconfigure Oracle clusterware stack
/
1025, RAC_DBS_EXISTS, "You must delete or downgrade Clusterware-managed Oracle databases and de-install Clusterware-managed Oracle homes before attempting to remove the Oracle Clusterware home."
...
// *Action:
/
1031, CMD_TO_RUN_FOR_IP, "The following information can be collected by running \"{0}\" on node \"{1}\""
// *Document: no
// *Cause: 
// *Action: 
/
...
/
1037, RUN_SIHA_DECONFIG_SILENT, "As the privileged user, execute  \"{0}\" on this node to remove the configuration of the Oracle Restart and to completely remove the Oracle software"
...
/
1040, CKPT_NAME_IS_NULL, "The checkpoint name entered is not valid"
// *Cause: 
// *Action: Enter a non-empty or valid input string
/
1041, NULL_FILE_PATH, "The file path entered is not valid"
// *Cause: 
// *Action: Enter an absolute path of a valid file
/
1042, CKPT_HELP_NOTE, ""
// *Document: NO
// *Cause:
// *Action:
/
1043, CKPT_OBASE_NOTE, ""
// *Document: NO
// *Cause:
// *Action:
/
1044, CKPT_NODELIST_NOTE, ""
// *Document: NO
// *Cause:
// *Action:
/
1045, CKPT_CHECK_NOTE, ""
// *Document: NO
// *Cause:
// *Action:
/
1046, CKPT_WRITE_NOTE, ""
// *Document: NO
// *Cause:
// *Action:
/
...
// *Action:
/
1050, CKPT_LEVEL_NOTE, ""
// *Document: NO
// *Cause:
// *Action:
/
1051, CKPT_STATE_NOTE, ""
// *Document: NO
// *Cause:
// *Action:
/
1052, CKPT_PNAME_NOTE, ""
// *Document: NO
// *Cause:
// *Action:
/
1053, CKPT_PVALUE_NOTE, ""
// *Document: NO
// *Cause:
// *Action:
/
1054, CKPT_STATUS_NOTE, ""
// *Document: NO
// *Cause:
// *Action:
/
1055, CKPT_PFILE_NOTE, ""
// *Document: NO
// *Cause:
// *Action:
/
1056, CRS_DECONFIG_INFO, "The deconfig command below can be executed in parallel on all the remote nodes. Execute the command on  the local node after the execution completes on all the remote nodes."
// *Document: no
// *Cause:
// *Action:
/
1057, NOT_A_CONFIGURED_HOME, "The home being deconfigured is NOT a configured Grid Infrastructure home ({0})"
...
/
1058, ROOT_SCRIPT_EXEC_MESG, "Root script execution in progress on nodes {0}"
// *Document: no
// *Cause:
// *Action:
/
1059, ROOT_SCRIPT_EXEC_FAIL_MESG, "Root script execution failed on nodes {0}"
...
//         Support Services.
/
1060, LOCAL_DELETE_INVALID, "Deleting the last node of a cluster using 'deinstall -local' is not allowed. Rerun deinstall without the '-local' flag."
...
/
1061, RUN_CRS_DECONFIG_SILENT_LOCAL, "As the privileged user, execute \"{1}\" on this node to remove the configuration of the Oracle Clusterware and to completely remove the Oracle software"
// *Document: no
// *Cause:
// *Action:
1062, CKPT_FILE_NOT_EXIST, "The checkpoint file \"{0}\" does not exist."
// *Cause: The checkpoint file to be worked on did not exist.
// *Action: This is an internal error. Contact Oracle Support Services.
/
1063, CLIENT_CLUSTER_EXISTS, "There are existing client clusters \"{0}\" using this server cluster."
...
// *Action: Deinstall the indicated client clusters before deinstalling this
...
// *Action:
/
1064, INVALID_HOSTS, "Host names \"{0}\" are invalid."
...
// *Action: Retry, specifying valid host names.
/
1065, HA_UNLOCKED, "Oracle Restart was successfully unlocked on node \"{0}\"."
// *Document: no
// *Cause:
// *Action:
/
1066, GI_UNLOCKED, "Oracle Clusterware was successfully unlocked on node \"{0}\"."
// *Document: no
// *Cause:
// *Action:
/
1067, MGMTDB_EXISTS, "The GIMR still exists while deinstalling the Oracle Grid Infrastructure home."
// *Cause: An attempt to deconfigure the Oracle Grid Infrastructure was rejected
//         because the Grid Infrastructure Management Repository (GIMR) still 
//         exists.
// *Action: Deinstall the GIMR, and then retry the operation.
/
1068, MGMTDB_FAILED_TO_CONNECT, "Failed to connect to GIMR in a remote cluster while deinstalling the Oracle Grid Infrastructure home."
// *Cause: An attempt to deconfigure the Oracle Grid Infrastructure was rejected
//         because the connection to the Grid Infrastructure Management 
//         Repository (GIMR) failed. 
// *Action: Ensure that the server GIMR is accessible and retry the operation.
/
1069, MGMTCA_DECONFIGREPOS_FAILED, "Failed to mark remote GIMR as deconfigured while deinstalling the Oracle Grid Infrastructure home."
// *Cause: An attempt to deconfigure the Oracle Grid Infrastructure was rejected
//         because the mgmtca command to deconfigure the current Grid
//         Infrastructure Management Repository (GIMR) failed. 
// *Action: Ensure that the pluggable database for the current cluster is open
//         in the server cluster where GIMR is installed and retry the
//         operation.
/
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                